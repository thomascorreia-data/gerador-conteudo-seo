...
## Categorias incompletas ou não implementadas

- [**Terminal rodoviário**](terminal_rodoviaria.md) — coleta pronta, geração de texto ainda não
- [**Estado, país, lugar genérico, evento**](nao_implementadas.md) — nada implementado ainda
